...
import 'package:afrimbox/api.dart';
import 'package:afrimbox/models/featuredmoviemodel.dart';
import 'package:afrimbox/models/genremodel.dart';
import 'package:afrimbox/ui/widgets/homepagefeaturedwidget.dart';
        ...
        body: SingleChildScrollView(
          child: Column(
            children: <Widget>[
              ...
              SectionContainer(
                sectionTitle: "Populaire sur Afrimbox",
                child: Container(
                  height: MediaQuery.of(context).size.height / 3,
                  child: FutureBuilder<List<FeaturedMovieModel>>(
                    future: featuredMovies,
